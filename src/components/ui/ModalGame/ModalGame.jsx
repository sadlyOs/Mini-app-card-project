            ...
            <div className="pb-3">
                <div className='px-5 pb-2'>
                    <div className='relative'>
                        ...
                        <input type="text" placeholder='Введите сумму' className='w-full outline-0 py-3 pl-[46px] pr-2 border-2 border-[#3C4350] rounded-2xl' />
                        <img src={ton} alt="ton" className='absolute top-[70%] left-3.5 translate-y-[-70%]' />
                    </div>
                </div>
                <div className='flex gap-2 overflow-x-scroll before:pl-5 block-scroll'>
                    <ButtonComponent style={'button-expend'}>
                        <img src={ton} alt="ton" />
                        <p>10</p>
                    </ButtonComponent>
                    <ButtonComponent style={'button-expend'} >
